...
def create_a_сaesar_encrypted_scv_file(
    ...
    def add_сaesar_encrypted_words_to_the_list_of_encrypted_words_by_сaesar(path_to_original_dict):
        ...
        with path_to_original_dict.open() as original_dict_csv:
            ...
            for row in reader:
                english_word = row[0]
                list_of_encrypted_words_by_сaesar.append(cesar(english_word, 3))
    ...
    list_of_encrypted_words_by_сaesar = add_сaesar_encrypted_words_to_the_list_of_encrypted_words_by_сaesar(path_to_original_dict)
    save_encrypted_data_to_a_data_file(path_to_save_the_created_file,list_of_encrypted_words_by_сaesar)


    


def create_a_grasshopper_encrypted_scv_file(
    path_to_original_dict, path_to_save_the_created_file
):
    pass
...
if __name__ == "__main__":
    # Comment out the function in the code when
    # you run the code if you don't want to create a corresponding scv
    ...
    # create_a_grasshopper_encrypted_scv_file()
